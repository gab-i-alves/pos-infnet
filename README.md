...
| # | Disciplina | Estado |
|---|---|---|
| 01 | SQL Avançado para Engenharia de Dados | a abrir |
| 02 | Transformação e Qualidade de Dados com dbt | a abrir |
| 03 | [Processamento de Big Data com Apache Spark e Spark SQL](03-spark/) | **em curso** |
| 04 | Implementação de Data Lakehouse com Databricks e Delta Lake | a abrir |
| 05 | ELT com AWS Glue Studio | a abrir |
| 06 | Orquestração de Pipelines de Dados com AWS Step Functions | a abrir |
| 07 | Data Streaming e Processamento em Tempo Real com Kafka | a abrir |
| 08 | Engenharia de Dados para MLOps e Inteligência Artificial | a abrir |
...
NN-disciplina/
  ...
  aula-NN/
    01-....md            dossiês de aprofundamento
    ...
    NN-perguntas-...md   perguntas para a aula ao vivo
  notebooks/             código e experimentos
```

Os documentos são markdown com frontmatter (`title`, `aula`, `data`, `tags`), então servem tanto para leitura direta no GitHub quanto para importação em qualquer sistema de notas.
